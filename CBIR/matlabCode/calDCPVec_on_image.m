...
for i = 1:PtsNum
    ...
    subplot(2,2,2); imshow(D1,[]);title('DCP E-1 encoded image');
    subplot(2,2,3); imshow(D2,[]);title('DCP E-2 encoded image');
...
% figure 
subplot(2,2,4); imshow(Result,[]);title('DCP encoded image');
