function [feature_vect] = LTrPs( input )
im=rgb2gray(input); 
...
%% feature vector
H1= histogram(ltrpat1);
H2= histogram(ltrpat2);
H3= histogram(ltrpat3);
H4= histogram(ltrpat4);
H5= histogram(ltrpat5);
H6= histogram(ltrpat6);
H7= histogram(ltrpat7);
H8= histogram(ltrpat8);
H9= histogram(ltrpat9);
H10= histogram(ltrpat10);
H11= histogram(ltrpat11);
H12= histogram(ltrpat12);
H13=histogram(ltrp_mag_Image);
feature_vect=zeros(1,13*59);
feature_vect=[H1,H2,H3,H4,H5,H6,H7,H8,H9,H10,H11,H12,H13];
end
